...
This will create a file called `billingreact.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/sebas/openmrs/openmrs-platform/owa`
